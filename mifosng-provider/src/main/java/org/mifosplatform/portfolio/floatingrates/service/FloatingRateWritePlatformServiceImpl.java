...
public class FloatingRateWritePlatformServiceImpl implements FloatingRateWritePlatformService {
    ...
    private final static Logger logger = LoggerFactory.getLogger(FloatingRateWritePlatformServiceImpl.class);
	...
	private void handleDataIntegrityIssues(final JsonCommand command, final DataIntegrityViolationException dve) {
        ...
        if (realCause.getMessage().contains("unq_name")) {
            ...
            throw new PlatformDataIntegrityException("error.msg.floatingrates.duplicate.name", "Floating Rate with name `" + name
