...
public class FloatingRatePeriod extends AbstractPersistable<Long> {
    ...
    public FloatingRatePeriodData toData(final FloatingRateDTO floatingRateDTO) {
        ...
        return new FloatingRatePeriodData(getId(), getFromDate(), interest, isDifferentialToBaseLendingRate(), isActive(), getCreatedBy()
                .getUsername(), getCreatedOn(), getModifiedBy().getUsername(), getModifiedOn());
    }
